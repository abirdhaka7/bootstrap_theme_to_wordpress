		...
		<div class="carousel slide" data-ride="carousel" id="myCarousel">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<svg class="bd-placeholder-img" height="100%" preserveaspectratio="xMidYMid slice" role="img" width="100%" xmlns="http://www.w3.org/2000/svg">
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				...
				<div class="col-md-5">
					...
					<text dy=".3em" fill="#aaa" x="50%" y="50%">
						500x500
					</text></svg>
				</div>
			</div>
