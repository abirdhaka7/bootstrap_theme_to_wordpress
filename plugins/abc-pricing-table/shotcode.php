...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
	...
	if(isset($post_id['template'])) {
		...
		if(isset($pricing_post_settings['pricing_table_design'])) $pricing_table_design = $pricing_post_settings['pricing_table_design']; else  $pricing_table_design = 13;
	}
	...
	wp_enqueue_script('apt-bootstrap-min-js', APT_PLUGIN_URL .'js/bootstrap.min.js', array('jquery'), '' , true);
	wp_enqueue_style('apt-bootstrap-css', APT_PLUGIN_URL .'css/bootstrap.css');
	wp_enqueue_style('apt-font-awesome-css', APT_PLUGIN_URL .'css/font-awesome.css');		
	...
	<div class="<?php echo $total_cols; ?>">			
		...
		if($pricing_table_design == 1) { $template_number = 1; include('css/template1.php'); }
		if($pricing_table_design == 2) { $template_number = 2; include('css/template2.php'); }
		if($pricing_table_design == 3) { $template_number = 3; include('css/template3.php'); }
		if($pricing_table_design == 4) { $template_number = 4; include('css/template4.php'); }
		...
		if($pricing_table_design == 1) { ?>
			...
			<?php } else if($pricing_table_design == 2) { ?>
			...
			<?php } else if($pricing_table_design == 3) { ?>
			...
			<?php } else if($pricing_table_design == 4) { ?>
