...
h3 {
	...
	.pricingContent_<?php echo $apt_id; ?> > ul > li:before{
		color: <?php echo $heading_background_color; ?>;
	}

.pricingTable-header_<?php echo $apt_id; ?> > .heading {
    display: block;
    padding: 7px 10px;
...
.active .heading-background_<?php echo $apt_id; ?> {
	background: <?php echo $feature_heading_background_color; ?>;
}
.active:hover .heading{
	background-color: <?php echo $feature_background_hover_color; ?>;
}
...
.active .pricingContent_<?php echo $apt_id; ?> > ul > li:before{
	color: <?php echo $feature_heading_background_color; ?> !important;
}
...
.heading_<?php echo $apt_id; ?> > .subtitle{
    font-size: 13px;
    margin-top: 3px;
    display: block;
}
...
.price-value_<?php echo $apt_id; ?> > span{
    font-size: 20px;
}
...
.pricingTable_<?php echo $apt_id; ?> > .pricingContent{
    margin: 10px 0 0 0;
}
.pricingContent > ul{
    padding: 0;
...
.btn-block_<?php echo $apt_id; ?>:after{
    content: "\f090";
    font-family: 'FontAwesome';
    padding-left: 10px;
    font-size: 15px;
}
.btn-block_<?php echo $apt_id; ?>:hover{
    border-radius: 10px;
}
